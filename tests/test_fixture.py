...
from src.abc import ILed, IBlackBox
...
class TestFixture(unittest.TestCase):
    def setUp(self):
        ...
        self._copilot = CoPilot(args, None, IBlackBox(), self._camera_info, ILed(), make_interpreter(args.ssd_model), make_interpreter(args.traffic_light_classification_model))
