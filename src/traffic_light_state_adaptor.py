...
class TrafficLightStateAdaptor(object):
    def __init__(self, is_full_mode):
    ...
    def update(self, state):
        ...
        if (
            ...
            and not self._was_yellow_now_red(traffic_light_state)
        ):
    ...
    def _was_yellow_now_red(self, traffic_light_state):
        return self._prev_state == "yellow" and is_red(traffic_light_state)
